...
local function RunAutoFarm()
    while true do
        if AutoFarmEnabled then
            -- Cole aqui o script de AutoFarm fornecido anteriormente
                                    ...
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == Ms and v:FindFirstChild("Humanoid") then
                                            if v.Humanoid.Health > 0 then
                                                ...
                                                until not v.Parent or v.Humanoid.Health <= 0 or AutoFarmEnabled == false or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
                                            end
                                        end
                                    end
                                else
